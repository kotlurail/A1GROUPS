...
const main = StyleSheet.create({
  ...
  topBar:         { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingTop: 52, paddingBottom: 12, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#e8eaf0' },
  topTitle:       { fontSize: 22, fontWeight: '800', color: '#1a1a2e' },
  addBtn:         { backgroundColor: '#6C63FF', paddingHorizontal: 16, paddingVertical: 9, borderRadius: 20 },
  addBtnTxt:      { color: '#fff', fontWeight: '700', fontSize: 14 },
  stickyBar:      { backgroundColor: '#f4f6fb', paddingTop: 10, paddingBottom: 4 },
  searchRow:      { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, gap: 10, marginBottom: 8 },
  searchInput:    { flex: 1, backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: '#e2e5f0', paddingHorizontal: 14, paddingVertical: 10, fontSize: 14, color: '#1a1a2e' },
  sortBtn:        { backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: '#e2e5f0', paddingHorizontal: 16, paddingVertical: 10 },
  sortBtnTxt:     { fontSize: 13, fontWeight: '700', color: '#555' },
  chipScroll:     { marginBottom: 8 },
  chip:           { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, borderWidth: 1, borderColor: '#e2e5f0', backgroundColor: '#fff' },
  ...
  statusChip:     { flex: 1, alignItems: 'center', paddingVertical: 7, borderRadius: 10, borderWidth: 1 },
  statusChipTxt:  { fontSize: 12, fontWeight: '700' },
  summaryRow:     { flexDirection: 'row', paddingHorizontal: 16, gap: 8, marginBottom: 10 },
  summaryCard:    { flex: 1, backgroundColor: '#fff', borderRadius: 12, padding: 10, alignItems: 'center', borderTopWidth: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 6, elevation: 2 },
  summaryVal:     { fontSize: 13, fontWeight: '800', marginBottom: 3 },
  summaryLabel:   { fontSize: 9, color: '#aaa', fontWeight: '600', textAlign: 'center' },
  resultsBar:     { flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 16, marginBottom: 6 },
  resultsCount:   { fontSize: 13, fontWeight: '700', color: '#555' },
  sortedBy:       { fontSize: 11, color: '#aaa' },
...
const dc = StyleSheet.create({
  card:         { marginHorizontal: 16, marginBottom: 14, backgroundColor: '#fff', borderRadius: 18, padding: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.07, shadowRadius: 10, elevation: 4 },
  topRow:       { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 8 },
  eventName:    { fontSize: 16, fontWeight: '800', color: '#1a1a2e' },
  customer:     { fontSize: 12, color: '#888' },
  typeBadge:    { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, backgroundColor: '#6C63FF22' },
  ...
  upcomingTxt:  { fontSize: 11, fontWeight: '700', color: '#2980b9' },
  finRow:       { flexDirection: 'row', borderTopWidth: 1, borderTopColor: '#f0f0f0', paddingTop: 10, marginBottom: 12 },
  finItem:      { flex: 1, alignItems: 'center' },
  finLabel:     { fontSize: 10, color: '#aaa' },
  finVal:       { fontSize: 13, fontWeight: '800', color: '#1a1a2e', marginTop: 2 },
  actionRow:    { flexDirection: 'row', gap: 6 },
  btn:          { flex: 1, paddingVertical: 9, borderRadius: 10, alignItems: 'center' },
  btnTxt:       { fontSize: 12, fontWeight: '700' },
  createdDate:  { fontSize: 10, color: '#ccc', marginTop: 10, textAlign: 'right' },
});

const dmod = StyleSheet.create({
  navbar:        { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingTop: Platform.OS === 'ios' ? 52 : 36, paddingBottom: 12, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#e8eaf0' },
  navBack:       { paddingVertical: 4, paddingRight: 8, minWidth: 60 },
  navBackTxt:    { fontSize: 14, fontWeight: '700', color: '#6C63FF' },
  navTitle:      { flex: 1, fontSize: 16, fontWeight: '800', color: '#1a1a2e', textAlign: 'center', marginHorizontal: 8 },
  navIconBtn:    { backgroundColor: '#f0f0f0', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 7 },
  navIconTxt:    { fontSize: 12, fontWeight: '700', color: '#555' },
  navSave:       { backgroundColor: '#6C63FF', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 7 },
  navSaveTxt:    { color: '#fff', fontWeight: '700', fontSize: 14 },
  navEdit:       { backgroundColor: '#6C63FF22', borderRadius: 12, paddingHorizontal: 14, paddingVertical: 7 },
  navEditTxt:    { color: '#6C63FF', fontWeight: '700', fontSize: 14 },
  statusBanner:  { flexDirection: 'row', alignItems: 'center', marginHorizontal: 16, marginTop: 12, marginBottom: 4, borderRadius: 12, padding: 14, borderWidth: 1 },
  statusTitle:   { fontSize: 14, fontWeight: '800' },
  statusSub:     { fontSize: 11, color: '#888', marginTop: 3 },
  statusDot:     { width: 12, height: 12, borderRadius: 6 },
  section:       { marginHorizontal: 16, marginTop: 12, backgroundColor: '#fff', borderRadius: 16, padding: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 6, elevation: 2 },
  sectionTitle:  { fontSize: 14, fontWeight: '800', color: '#1a1a2e', marginBottom: 10 },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 },
  hint:          { fontSize: 13, color: '#bbb', fontStyle: 'italic', paddingVertical: 4 },
  ...
  infoTable:     { borderWidth: 1, borderColor: '#f0f0f0', borderRadius: 10, overflow: 'hidden' },
  infoRow:       { flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 12, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#f5f5f5' },
  infoKey:       { fontSize: 12, color: '#aaa', fontWeight: '600' },
  infoVal:       { fontSize: 13, color: '#1a1a2e', fontWeight: '600', flex: 1, textAlign: 'right' },
  tableHead:     { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f8f9ff', paddingHorizontal: 8, paddingVertical: 7, borderRadius: 8, marginBottom: 2 },
  thCell:        { fontSize: 11, fontWeight: '700', color: '#888' },
  tableRow:      { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 8, borderRadius: 6, gap: 4 },
  tdCell:        { fontSize: 13, color: '#333' },
  cellInput:     { backgroundColor: '#f4f6fb', borderRadius: 8, borderWidth: 1, borderColor: '#e2e5f0', paddingHorizontal: 8, paddingVertical: 7, fontSize: 12, color: '#1a1a2e' },
  totalBar:      { flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#6C63FF', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, marginTop: 8 },
  totalBarLabel: { fontSize: 13, fontWeight: '700', color: '#fff' },
  totalBarVal:   { fontSize: 16, fontWeight: '800', color: '#fff' },
  addRowBtn:     { backgroundColor: '#6C63FF22', borderRadius: 14, paddingHorizontal: 12, paddingVertical: 6 },
  addRowTxt:     { fontSize: 12, fontWeight: '700', color: '#6C63FF' },
  payGrid:       { flexDirection: 'row', gap: 8, marginBottom: 10 },
  payGridItem:   { flex: 1, backgroundColor: '#f8f9ff', borderRadius: 10, padding: 10, alignItems: 'center' },
  payGridLabel:  { fontSize: 10, color: '#aaa', marginBottom: 3 },
  payGridVal:    { fontSize: 13, fontWeight: '800', color: '#1a1a2e' },
  calcBox:       { backgroundColor: '#f8f9ff', borderRadius: 12, padding: 12, marginTop: 10, borderWidth: 1, borderColor: '#e2e5f0' },
  calcRow:       { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 5 },
  calcTotalRow:  { borderTopWidth: 1, borderTopColor: '#e0e4f0', marginTop: 4, paddingTop: 8 },
  calcLabel:     { fontSize: 13, color: '#666' },
  calcVal:       { fontSize: 13, fontWeight: '600', color: '#1a1a2e' },
  statusPill:    { borderRadius: 10, paddingVertical: 10, alignItems: 'center', borderWidth: 1, marginTop: 10 },
  statusPillTxt: { fontSize: 13, fontWeight: '700' },
  reqRow:        { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 9, gap: 6, borderRadius: 6 },
  commentsBox:   { fontSize: 14, color: '#444', lineHeight: 22, backgroundColor: '#f8f9ff', borderRadius: 10, padding: 12, borderWidth: 1, borderColor: '#e2e5f0' },
  bottomRow:     { flexDirection: 'row', gap: 12, marginHorizontal: 16, marginTop: 16 },
  cancelBtn:     { flex: 1, paddingVertical: 14, borderRadius: 14, borderWidth: 1.5, borderColor: '#e2e5f0', alignItems: 'center' },
