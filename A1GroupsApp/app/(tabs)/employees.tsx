...
const main=StyleSheet.create({
  ...
  navBtn:         {width:36,height:36,borderRadius:18,backgroundColor:'#e8eaf0',alignItems:'center',justifyContent:'center'},
  navTxt:         {fontSize:16,fontWeight:'700',color:'#1a1a2e'},
  monthTitle:     {fontSize:17,fontWeight:'700',color:'#1a1a2e'},
  summaryCard:    {marginHorizontal:16,marginBottom:12,backgroundColor:'#fff',borderRadius:16,padding:16,shadowColor:'#000',shadowOffset:{width:0,height:2},shadowOpacity:0.06,shadowRadius:8,elevation:3},
  summaryHeading: {fontSize:12,fontWeight:'700',color:'#aaa',marginBottom:10,textTransform:'uppercase',letterSpacing:0.5},
  summaryRow:     {flexDirection:'row'},
  sumItem:        {flex:1,alignItems:'center'},
  sumLabel:       {fontSize:11,color:'#aaa',marginBottom:2},
  sumVal:         {fontSize:15,fontWeight:'800'},
...
const ec=StyleSheet.create({
  card:        {marginHorizontal:16,marginBottom:12,backgroundColor:'#fff',borderRadius:16,padding:16,shadowColor:'#000',shadowOffset:{width:0,height:2},shadowOpacity:0.06,shadowRadius:8,elevation:3},
  ...
  salaryAmt:   {fontSize:16,fontWeight:'800',color:'#6C63FF'},
  salaryLabel: {fontSize:11,color:'#aaa'},
  attRow:      {flexDirection:'row',gap:8,marginBottom:10},
  attChip:     {flex:1,alignItems:'center',paddingVertical:6,borderRadius:10},
  attNum:      {fontSize:16,fontWeight:'800'},
  attLbl:      {fontSize:10,fontWeight:'600',marginTop:1},
  finRow:      {flexDirection:'row',borderTopWidth:1,borderTopColor:'#f0f0f0',paddingTop:10},
...
const sh=StyleSheet.create({
  ...
  sheet:     {backgroundColor:'#fff',borderTopLeftRadius:24,borderTopRightRadius:24,paddingHorizontal:16,paddingBottom:Platform.OS==='ios'?34:16},
  ...
  close:     {fontSize:18,color:'#888',padding:4},
  label:     {fontSize:11,fontWeight:'700',color:'#888',marginTop:14,marginBottom:6,textTransform:'uppercase',letterSpacing:0.5},
  input:     {backgroundColor:'#f4f6fb',borderRadius:12,borderWidth:1,borderColor:'#e8eaf0',paddingHorizontal:14,paddingVertical:12,fontSize:14,color:'#1a1a2e'},
  actionRow: {flexDirection:'row',gap:12,marginTop:20},
  cancelBtn: {flex:1,paddingVertical:14,borderRadius:14,borderWidth:1.5,borderColor:'#e8eaf0',alignItems:'center'},
  cancelTxt: {fontSize:15,fontWeight:'700',color:'#888'},
...
const det=StyleSheet.create({
  overlay:        {flex:1,justifyContent:'flex-end',backgroundColor:'rgba(0,0,0,0.4)'},
  sheet:          {backgroundColor:'#f4f6fb',borderTopLeftRadius:24,borderTopRightRadius:24,paddingBottom:Platform.OS==='ios'?34:16},
  handle:         {width:40,height:4,backgroundColor:'#e0e0e0',borderRadius:2,alignSelf:'center',marginTop:12,marginBottom:4},
  titleRow:       {flexDirection:'row',alignItems:'flex-start',paddingHorizontal:16,paddingTop:8,paddingBottom:8},
  title:          {fontSize:20,fontWeight:'800',color:'#1a1a2e'},
  subtitle:       {fontSize:13,color:'#666',marginTop:2},
  period:         {fontSize:11,color:'#aaa',marginTop:2},
  editBtn:        {backgroundColor:'#6C63FF22',borderRadius:20,paddingHorizontal:14,paddingVertical:7,marginTop:4},
  editBtnTxt:     {fontSize:13,fontWeight:'700',color:'#6C63FF'},
  chipRow:        {flexDirection:'row',gap:8,paddingHorizontal:16,marginBottom:8},
  chip:           {flex:1,backgroundColor:'#fff',borderRadius:12,padding:10,alignItems:'center',borderWidth:1,borderColor:'#e8eaf0'},
  chipLabel:      {fontSize:10,color:'#aaa',marginBottom:2},
  chipVal:        {fontSize:13,fontWeight:'800',color:'#1a1a2e'},
  card:           {marginHorizontal:16,marginBottom:12,backgroundColor:'#fff',borderRadius:16,padding:16,shadowColor:'#000',shadowOffset:{width:0,height:1},shadowOpacity:0.04,shadowRadius:6,elevation:2},
  cardTitle:      {fontSize:14,fontWeight:'800',color:'#1a1a2e',marginBottom:2},
  cardHint:       {fontSize:11,color:'#aaa',marginBottom:8},
  attCountRow:    {flexDirection:'row',gap:6,marginTop:12},
  attCountChip:   {flex:1,alignItems:'center',paddingVertical:8,borderRadius:10,borderWidth:1},
  attCountNum:    {fontSize:18,fontWeight:'800'},
  attCountLabel:  {fontSize:9,fontWeight:'600',marginTop:1},
  earnedBox:      {backgroundColor:'#f8f9ff',borderRadius:12,padding:12,borderWidth:1,borderColor:'#e8eaf0',marginTop:12},
  earnedRow:      {flexDirection:'row',justifyContent:'space-between',paddingVertical:3},
  earnedLabel:    {fontSize:13,color:'#666'},
  earnedVal:      {fontSize:13,fontWeight:'600',color:'#1a1a2e'},
  emptyHint:      {fontSize:13,color:'#bbb',fontStyle:'italic',paddingVertical:8},
  cashItem:       {flexDirection:'row',alignItems:'center',gap:8,paddingVertical:10,borderBottomWidth:1,borderBottomColor:'#f0f0f0'},
  cashDot:        {width:8,height:8,borderRadius:4,flexShrink:0},
  cashNote:       {fontSize:13,fontWeight:'600',color:'#1a1a2e'},
  cashMeta:       {fontSize:11,color:'#aaa',marginTop:1},
  cashAmt:        {fontSize:14,fontWeight:'800'},
  delBtn:         {padding:4},
  delTxt:         {fontSize:12,color:'#e74c3c'},
  inputLabel:     {fontSize:11,fontWeight:'700',color:'#888',marginTop:12,marginBottom:6,textTransform:'uppercase',letterSpacing:0.3},
  typeRow:        {flexDirection:'row',gap:8,marginBottom:4,flexWrap:'wrap'},
  typeChip:       {paddingHorizontal:12,paddingVertical:8,borderRadius:20,borderWidth:1.5,borderColor:'#e8eaf0',backgroundColor:'#f8f9ff'},
  typeChipActive: {backgroundColor:'#6C63FF',borderColor:'#6C63FF'},
  typeChipTxt:    {fontSize:12,fontWeight:'700',color:'#555'},
  input:          {backgroundColor:'#f4f6fb',borderRadius:12,borderWidth:1,borderColor:'#e8eaf0',paddingHorizontal:14,paddingVertical:12,fontSize:14,color:'#1a1a2e'},
  actionBtn:      {backgroundColor:'#6C63FF',borderRadius:14,paddingVertical:14,alignItems:'center'},
  actionBtnTxt:   {fontSize:15,fontWeight:'700',color:'#fff'},
  summaryBlock:   {backgroundColor:'#f8f9ff',borderRadius:12,padding:12,borderWidth:1,borderColor:'#e8eaf0'},
  sumRow:         {flexDirection:'row',justifyContent:'space-between',paddingVertical:6,borderBottomWidth:1,borderBottomColor:'#eee'},
  sumLabel:       {fontSize:13,color:'#666',flex:1},
  sumVal:         {fontSize:13,fontWeight:'600',color:'#1a1a2e'},
  sumTotalRow:    {borderBottomWidth:0,borderTopWidth:2,borderTopColor:'#e0e4f0',marginTop:4,paddingTop:10},
  sumTotalLabel:  {fontSize:14,fontWeight:'800',color:'#1a1a2e',flex:1},
  sumTotalVal:    {fontSize:16,fontWeight:'800'},
  pendingBanner:  {marginTop:12,backgroundColor:'#fff8ec',borderRadius:10,paddingHorizontal:14,paddingVertical:10,borderWidth:1,borderColor:'#f0c27f'},
  pendingTxt:     {fontSize:13,fontWeight:'700',color:'#d35400',textAlign:'center'},
  deleteBtn:      {marginHorizontal:16,marginTop:8,marginBottom:4,paddingVertical:14,borderRadius:14,borderWidth:1.5,borderColor:'#e74c3c',alignItems:'center'},
  deleteBtnTxt:   {fontSize:14,fontWeight:'700',color:'#e74c3c'},
});
